...
@trend_bp.route('/trend-phases', methods=['GET'])
...
@trend_bp.route('/trend-phases', methods=['POST'])
...
# Trend Scoring
@trend_bp.route('/contents/<int:content_id>/scores', methods=['GET'])
...
@trend_bp.route('/contents/<int:content_id>/scores', methods=['POST'])
...
# Trend Analytics
@trend_bp.route('/trends/analytics/dashboard', methods=['GET'])
...
# Trend Correlations
@trend_bp.route('/trends/correlations', methods=['GET'])
